...
from .heatmap_temp import generate_thmap_data, generate_hmap
...
class CarlaMVDetDataset(BaseIODataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.head == "det":
            ...
            htmap = (generate_thmap_data(copy.deepcopy(measurements), copy.deepcopy(actors_data)).reshape(20*20, -1).astype(np.float32))
